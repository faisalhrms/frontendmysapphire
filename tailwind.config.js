...
theme: {
  ...
  extend: {
    ...
    boxShadow: {
      ...
      'all-sides': '0px 4px 10px rgba(0, 0, 0, 0.1), 0px -4px 10px rgba(0, 0, 0, 0.1)', // Light mode shadow on all sides
      'dark-all-sides': '0px 4px 15px rgba(0, 0, 0, 0.2), 0px -4px 15px rgba(0, 0, 0, 0.2)', // Dark mode shadow on all sides
    },
    backgroundImage: {
      instagram: "linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)",
      "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
      "gradient-1": "linear-gradient(102deg, light 41%, transparent 0)",  // This one will be used
    },
  },
  animation: {
