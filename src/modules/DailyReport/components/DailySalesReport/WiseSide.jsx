...
//                     initialExpanded[aClassRow.id] = true;
//
//                     // Find "Center", "North", and "South" regions under "A-Class"
//                     const centerRow = data.find(row =>
//                         row.parentId === aClassRow.id &&
//                         (row.type === "Center" || row.type === "Central")
//                     );
//
//                     const northRow = data.find(row =>
//                         row.parentId === aClassRow.id &&
//                         row.type === "North"
//                     );
//
//                     const southRow = data.find(row =>
//                         row.parentId === aClassRow.id &&
//                         row.type === "South"
//                     );
//
//                     // Expand "Center," "North," and "South" by default
