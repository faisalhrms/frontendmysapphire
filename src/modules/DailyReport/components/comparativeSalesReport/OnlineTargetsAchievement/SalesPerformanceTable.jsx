                    ...
                    {data.map((row, index) => {
                        ...
                        return (
                            <tr key={index} className={rowClass}>
                                ...
                                <td className={`border p-2 text-center font-bold border-gray-400  text-black dark:text-gray-200 dark:bg-bodybg ${getGrowthColor(row.full_price.achievement)}`}>
                                ...
                                <td className={`border font-bold  border-gray-400 p-2 text-center text-black dark:text-gray-200 dark:bg-bodybg ${getGrowthColor(row.discounted.achievement)}`}>
