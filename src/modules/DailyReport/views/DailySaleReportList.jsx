...
import {getCurrentDate, getPastDate} from "@helpers/dateTime.js";
...
const OfflineStorePerformList=()=>{
    ...
    const {
        ...
        useMemo(
            () => ({
                initialFilters: [
                    { name: 'p_date',defaultValue: getPastDate()},
                    { name: 'date_from',defaultValue: getCurrentDate()},
                    { name: 'date_to',defaultValue: getPastDate()},
                ],
            }),
            []
        )
