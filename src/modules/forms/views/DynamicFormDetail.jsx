...
const DynamicFormDetail = () => {
    const {id} = useParams();
    const {data:formData, isLoading} = useDynamicFormEdit(id);
    const fields = formData?.fields || [];
    return (
        <>
            <IconPageHeader
                heading="Detail Page"
                description="View detailed information, configurations, and approval settings for the selected form."
                icon={FileCheck2}
            />
            {isLoading
                ? <LoadingSpinner/> :
                        ...
                        <ul className="list-group list-group-flush list-none !rounded-md">
                                        ...
                                        <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        className="text-base font-mono bg-white py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg">{formData.title}</span>
                                                </div>
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        className="ext-base font-mono bg-white py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg"> {formData.description}</span>
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        className="ext-base font-mono bg-white py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg">{formData.success_message}</span>
                                                </div>
                                        ...
                                        <span
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500">
                                                        View the font style used for your brand’s visual tone and
                                                        readability.
                                                    </p>
                                                </div>
                                                <div>
                            ...
                            <li className="list-group-item">
                                ...
                                {formData?.enable_coupon && (<div
                                    ...
                                    <div
                                        className="bg-white  border mt-4 p-6 space-y-6 dark:text-gray-200 dark:bg-bodybg">

                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div>
                                                <p className="text-sm font-medium ">Country</p>
                                                <p className="mt-1 text-xs text-gray-500">
                                                    {formData?.coupon_config_option?.country || "-"}
                                                </p>
                                            </div>
                                            <div>
                            ...
                            <li className="list-group-item">
                                <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                                    <div className="xl:col-span-4 col-span-12">
                                        <p className="text-[1rem] mb-1 font-semibold dark:text-gray-200 dark:bg-bodybg">
                                            Email to Submitter
                                        </p>
                                        <p className="text-[0.75rem] mb-0 text-[#8c9097] dark:text-white/50 dark:text-gray-200 dark:bg-bodybg">
                                            View the Automatically send a confirmation or notification email to the
                                            form submitter.
                                        </p>
                                    </div>
                                    ...
                                    <div className="xl:col-span-8 col-span-12 flex justify-between items-center">
                                        ...
                                        <input
                                            type="checkbox"
                                            checked={formData?.send_email_to_submitter}
                                            readOnly
                                            className="w-5 h-5 accent-indigo-600"
                                        />
                                    </div>

                                    {formData?.is_active && formData?.send_email_to_submitter && (
                                        <div className="xxl:col-span-12 xl:col-span-12 col-span-12">
                                            <div>
                                                <p className="font-semibold mb-4">{formData?.email_subject || ""}</p>
                                                <div
                                                    className="text-base text-gray-700 dark:text-gray-300 mt-4"
                                ...
                                <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-6">
                                    <div className="xl:col-span-12 col-span-12">
                                        <div className="flex items-center space-x-3 mb-3">
                                            <div>
                                                <h3 className="text-base font-semibold text-gray-900 dark:text-gray-200 dark:bg-bodybg">Form
                                                    Fields</h3>

                                            </div>
                                        </div>
                                        <p className="text-[0.75rem] mb-0 text-[#8c9097] dark:text-white/50 dark:text-gray-200 dark:bg-bodybg">
                                            View all form field configurations including field types, validation rules,
                                            and
                                            display settings.
                                        </p>
                                    </div>
                            ...
                            <div className="list-group-item">
                                <div
                                    className={`table-responsive task-table overflow-hidden transition-all duration-300`}>
                                    <table className="table whitespace-nowrap table-bordered min-w-full">
                                        <thead>
                                        <tr className="border-b border-defaultborder">
                                            <th className='relative text-center'>Label</th>
                                            <th className='relative text-center'>Short Description</th>
                                            <th className='relative text-center'>Required</th>
                                            <th className='relative text-center'>Unique</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        {fields.map((field, indx) => (
                                            <tr className='border-b border-defaultborder' key={indx}>
                                                <td>{field.label}</td>
                                                <td>{field.short_description}</td>
                                                <td><input type="checkbox" checked={field.required} readOnly /></td>
                                                <td><input type="checkbox" checked={field.unique} readOnly /></td>
                                            </tr>
                                        ))}
                                        </tbody>
                                    </table>
