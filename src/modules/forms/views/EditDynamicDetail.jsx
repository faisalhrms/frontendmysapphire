                                ...
                                <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                                    ...
                                    <div className="xl:col-span-12 col-span-12 flex justify-between items-center">
                                        <div>
                                            ...
                                            <span
                                                className="text-base font-mono bg-white px-2 py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg">{formData.title}</span>
                                        </div>
                                    ...
                                    <div className="xl:col-span-12 col-span-12 flex justify-between items-center">
                                        <div>
                                            ...
                                            <span
                                                className="ext-base font-mono bg-white px-2 py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg"> {formData.description}</span>
                                    ...
                                    <div className="xl:col-span-12 col-span-12 flex justify-between items-center">
                                        <div>
                                            ...
                                            <span
                                                className="ext-base font-mono bg-white px-2 py-1 rounded  text-gray-500 dark:text-gray-200 dark:bg-bodybg">{formData.success_message}</span>
                                        </div>
                        ...
                        <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-4">
                            ...
                            {formData?.is_active && formData?.send_email_to_submitter && (
                                <div className="xxl:col-span-12 xl:col-span-12 col-span-12">
                                    <div>
                                        <p className="font-semibold">{formData?.email_subject || ""}</p>
                                        <div
                    ...
                    <li className="list-group-item bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 p-6 ">
                        <div className="grid grid-cols-12 xl:gap-x-[3rem] gap-y-6">
                            <div className="xl:col-span-4 col-span-12">
                                ...
                                <p className="text-[0.75rem] mb-0 text-[#8c9097] dark:text-white/50 dark:text-gray-200 dark:bg-bodybg">
                                    View all form field configurations including field types, validation rules, and
                                    display settings.
                                </p>
                            </div>
