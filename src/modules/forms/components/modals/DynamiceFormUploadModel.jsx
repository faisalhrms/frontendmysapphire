...
const DynamiceFormUploadModal = ({control, errors, isSubmitting, handleSubmit, onSubmit, closeModal, heading = 'Upload Data' }) => {
    const handleClose = useCallback(() => closeModal(), [closeModal]);
    return (<div id="uploadApprovalSetupModal" data-hs-overlay-keyboard="false" className="hs-overlay ti-modal hidden [--overlay-backdrop:static] backdrop-blur-[0.08rem]">
            ...
            <div className="max-h-full overflow-hidden ti-modal-content">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="ti-modal-header">
                        <h6 className="modal-title" id="staticBackdropLabel3">{heading}</h6>
...
export default  DynamiceFormUploadModal;
