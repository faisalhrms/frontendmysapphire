...
import DynamiceFormApproverRow from "@modules/forms/components/DynamiceFormApprovalSetup/dynamiceFormApproveRow.jsx";

const DynamiceFormApproverFieldArray = ({ control, errors, setValue }) => {
...
export default React.memo(DynamiceFormApproverFieldArray);
