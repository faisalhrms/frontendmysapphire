...
const ApprovalTypeForm = ({ editMode = false, approvalTypeId = null }) => {
  ...
  const customEmailTemplatesEnabled = watch("custom_email_templates_enabled");
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="grid grid-cols-12 gap-4">
                ...
                {/* TEMPLATE PATHS UNDER APPROVAL PAGE URL */}
                {customEmailTemplatesEnabled && (
                  <>
                    <div className="col-span-12">
                      <FormInput
                        name="approver_email_template"
                        control={control}
                        errors={errors}
                        placeholder="Approver Email Template"
                      />
                    </div>
                    <div className="col-span-12">
                      <FormInput
                        name="requester_email_template"
                        control={control}
                        errors={errors}
                        placeholder="Requester Email Template"
                      />
                    </div>
                  </>
                )}
