...
const ApprovalHierarchyApproverSetupModal = ({
                                control,
                                errors,
                                closeModal,
                                handleSubmit,
                ...
                <div className="ti-modal-content">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="ti-modal-header">
                            <h6 className="modal-title">Approval Hierarchy Approver Setup</h6>
                            <button
                                type="button"
                            ...
                            <div className="grid grid-cols-12 gap-4">
                                <div className="col-span-12">
                                    <FormAsyncSelect
                                        ...
                                        is_required={true}
                                        apiUrl="/approvals/hierarchy/select"
                                        queryKeyBase="hierarchy-approvers"
                                        className="w-full"
                                        preselectedOptions={hierarchyPre}
...
export default React.memo(ApprovalHierarchyApproverSetupModal);
