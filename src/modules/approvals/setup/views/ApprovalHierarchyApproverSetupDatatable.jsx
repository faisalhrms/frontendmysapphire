...
import ApprovalHierarchyApproverSetupModal
    from "@modules/approvals/setup/components/ApprovalHierarchyApproverSetupModal.jsx";
import {
    useApprovalHierarchyApproverSetupModal
} from "@modules/approvals/setup/hooks/useApprovalHierarchyApproverSetupModal.js";
...
const ApprovalHierarchyApproverSetupDatatable = () => {
    ...
    return (
        <>
            <IconPageHeader
                heading="Approval hierarchy Approvers"
                description="Set up and manage multi-level approval workflows, assigning users to each level dynamically."
                icon={Layers}
            />
            <DataTable
                ref={dataTableRef}
                columns={columns}
                apiUrl="/approvals/hierarchy/approver/datatable/"
                needHeader={false}
                enableAdvancedFilters={false}
                buttons={buttons}
            />

            <ApprovalHierarchyApproverSetupModal {...modalProps} />
        </>
    );
};

export default React.memo(ApprovalHierarchyApproverSetupDatatable);
