...
const UploadErrorModal = ({ jobId, closeModal }) => {
  ...
  // This handleClose replicates the structure from your DataSanitizeModel.
  // It closes via HSOverlay and then calls the parent closeModal.
  ...
  // On mount, open the modal via HSOverlay
  useEffect(() => {
    const modal = document.getElementById("uploadErrorModal");
        ...
        <div className="max-h-full mx-auto overflow-hidden ti-modal-content">
            <form onSubmit={handleSubmit}>
                <div className="ti-modal-header">
                    <h6 className="modal-title">Upload Missing Rules</h6>
                    <button
                        type="button"
                        ...
                        <div className="col-span-12">
                            ...
                            <input
                                ...
                                className="block w-full border border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm
                                         text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10
                                          dark:text-[#8c9097] dark:text-white/50 file:me-4 file:py-2 file:px-4 file:rounded-s-sm file:border-0
                                          file:text-sm file:font-semibold file:bg-primary
                                          file:text-white hover:file:bg-primary focus-visible:outline-none"
                            />
                        </div>
                    </div>
                </div>
