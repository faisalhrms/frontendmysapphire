...
//                                     {!showLabelsCard && (
//                                         <div
//                                             className={`bg-white/95 backdrop-blur-sm border-2 border-gray-200 rounded-xl shadow-xl p-3 min-w-[166px] transition-all duration-300 cursor-pointer ${
...
//                                                     {point.subtitle && (
//                                                         <div
//                                                             className="text-xs text-green ml-10 mt-1 font-semibold cursor-pointer hover:text-blue-800">
//
//                                                             {isExpanded ? "−" : "+"}
//                                                         </div>
//                                                     )}
...
//                             }}
//                         >
//                             <div className="bg-white/95 backdrop-blur-sm border-2 border-gray-200 rounded-xl shadow-2xl p-2 min-w-[200px] max-w-[250px] animate-in fade-in duration-300">
                        ...
                        return (
                            <div key={point.id}>
                                ...
                                >
                                    {!showLabelsCard && (
                                        <div
                                            className={`bg-white/95 backdrop-blur-sm border-2 border-gray-200 rounded-xl shadow-xl p-1 min-w-[166px] ${
                                                selectedPin === point.id
                                                    ? "scale-110 shadow-2xl border-blue-400 bg-white"
                                                    : " hover:shadow-lg"
                                            }`}
