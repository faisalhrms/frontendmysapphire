...
import { useImporterClassificationModal } from "@modules/beirholm-bi/hooks/useImporterClassificationModal.js";

const ClassificationModel = ({ closeModal, refreshTable }) => {
  const { register, handleSubmit, errors, isSubmitting, onSubmit, control } = useImporterClassificationModal();

  const handleClose = useCallback(() => {
    const modal = document.getElementById("ClassificationModel");
        ...
        <div className="max-h-full mx-auto overflow-hidden ti-modal-content">
          ...
          >
            <div className="ti-modal-header">
              <h6 className="modal-title">Upload Focus Buyers & Classifications</h6>
              <button
                type="button"
