                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="ti-modal-header">
                            <h6 className="modal-title"
                                id="staticBackdropLabel3"> {isEditMode ? 'Update Year' : 'Add Year'}</h6>
                            ...
                            <div className="xl:col-span-6 col-span-12">
                                <FormSelect
                                    ...
                                    options={(() => {
                                        ...
                                        return [
                                            { value: thisYear.toString(), label: thisYear.toString() },
                                            { value: (thisYear + 1).toString(), label: (thisYear + 1).toString() },
                                        ];
                                    })()}
                                    is_required={true}
                                />
