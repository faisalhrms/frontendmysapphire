        ...
        <tr className="border-b border-gray-50 hover:bg-primary/5 transition-colors group">
                    ...
                    <div className="text-xs text-gray-600 leading-relaxed">
                        ...
                        {shouldTruncate && (
                            <button
                                ...
                                className="ml-2 text-blue-600 hover:text-blue-800 font-medium inline-flex items-center gap-1 transition-colors"
                            >
                                {isExpanded ? (
            ...
            <td className="px-6 py-4">
                <div className="text-right space-y-1">
                    <div className={`font-bold ${vendorAmount > 0 ? "text-gray-900" : "text-gray-400"}`}>
