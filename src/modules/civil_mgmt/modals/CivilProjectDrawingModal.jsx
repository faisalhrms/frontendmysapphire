...
const CivilProjectDrawingModal = ({control, errors, isSubmitting, handleSubmit, onSubmit, closeModal, isEditMode = false, formData}) => {
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="ti-modal-header">
                            <h6 className="modal-title"
                                id="staticBackdropLabel3"> {isEditMode ? 'Update Drawing' : 'Add New Drawing'}</h6>
                        ...
                        <div className="ti-modal-body overflow-y-auto max-h-[calc(100vh-200px)]">
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="col-span-12">
                                    <GalleryUpload
                                        currentValue={formData?.files}
                                        files={formData?.attached_files}
                                        inputName="files"
...
export default CivilProjectDrawingModal;
