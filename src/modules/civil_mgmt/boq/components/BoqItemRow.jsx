        ...
        <tr className="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
            ...
            <td className="px-4 py-4">
                <div className="space-y-1">
                    <div className="inline-flex items-center gap-1.5 px-2 py-0.5 bg-gray-100 text-gray-700 text-xs font-mono rounded border dark:text-gray-200 dark:bg-bodybg">
                        <Hash size={10} />
                        {item.item_no}
                    </div>
            ...
            <td className="px-4 py-4 text-center">
                <span className="inline-flex px-2 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded border border-blue-200 dark:text-gray-200 dark:bg-bodybg">
                    {item.unit}
                </span>
            </td>
