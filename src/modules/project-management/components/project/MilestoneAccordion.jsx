                            ...
                            {milestone.children.length > 0 && activeMilestoneId === milestone.id && (
                                <div
                                    ...
                                    <div className="accordion-body">
                                        <TaskTable projectStatus={projectStatus} tasks={milestone.children}
                                                   milestoneStatus={milestone.status} startedAt={milestone.started_at}
                                                   endedAt={milestone.ended_at} openTaskModal={openTaskModal}/>
                                    </div>
                                </div>
                            )}
                        </div>
