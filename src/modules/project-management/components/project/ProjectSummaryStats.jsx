                        ...
                        <ApexChart
                            ...
                            additionalOptions={{
                                legend: {position: 'left'}, stroke: {
                                    curve: 'smooth', lineCap: 'round', colors: ["#fff"], width: 0, dashArray: 0
                                }
                            }}
            ...
            <div className="box-footer !p-0">
                <div className="grid grid-cols-12 justify-center">
                    {summary?.labels.map((label, index) => {
                        return (<div className="col-span-3 pe-0 text-center" key={index}>
                                <div className="sm:p-4 p-2">
                                    <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem]">{label}</span>
                                    <span className="block text-[1rem] font-semibold">{summary.series[index]}</span>
                                </div>
                            </div>)
                    })}
                </div>
