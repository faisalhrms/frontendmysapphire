                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-end">
                                ...
                                <div className="lg:col-span-2">
                                    ...
                                    <p className="text-lg md:text-xl text-slate-200 mb-6 max-w-3xl">
                                        ...
                                        Our team covers everything you need to get started in this comprehensive course.
                                    </p>
                        ...
                        {formatDate(offering?.start_date)} - {formatDate(offering?.end_date)}
                            ...
                            {canSelfEnroll ? "Allowed" : "Not Allowed"}
                                ...
                                Enrolling...
                                                        ...
                                                        ) : canSelfEnroll ? "Enroll Now" : "Enrollment Closed"}
                                                    </button>
                                                )}
                                                ...
                                                {canOpenCourse && (
                                                    <>
                                                        ...
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="w-full inline-flex items-center justify-center gap-2 py-3 px-6 rounded-2xl font-bold border-2 border-white/30 text-white hover:bg-white/10 transition-all"
                                                        >
                                                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8">
                            ...
                            <p className="text-slate-600 leading-relaxed mb-6">
                                ...
                                You'll gain hands-on experience and develop skills that are directly applicable to real-world scenarios.
                                Our expert instructors have designed this curriculum to ensure you build a solid foundation in the subject matter.
                            </p>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                                    <div className="text-sm font-bold text-blue-600 uppercase mb-2">Start Date</div>
                                    <div className="text-xl font-bold text-slate-900">{formatDate(offering?.start_date)}</div>
                                </div>

                                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                                    <div className="text-sm font-bold text-purple-600 uppercase mb-2">End Date</div>
                                    <div className="text-xl font-bold text-slate-900">{formatDate(offering?.end_date)}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl shadow-xl p-6 text-white">
                            ...
                            <ul className="space-y-3">
                                {["Core fundamental principles", "Practical applications", "Industry best practices", "Real-world projects"].map((item, i) => (
