...
const ActionHistory = ({ actionHistory }) => {
    const getActionConfig = (actionHistory) => {
        switch (actionHistory.toLowerCase()) {
            case 'submitted':
                return {
                    icon: Send,
                    color: 'bg-blue-500',
    ...
    const sortedActions = [...actionHistory].reverse();
                ...
                <div className="mt-8 bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl p-4 border border-slate-200">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                            <div className="text-lg font-bold text-slate-900">{actionHistory.length}</div>
