...
const ObjectiveForm = ({ year = null, editMode = false, isLoading }) => {
    ...
    return (
        <>
            <form>
                <div className={`box relative ${isFullscreen ? 'box-fullscreen' : ''}`}
                     style={{maxHeight: isFullscreen ? '100vh' : '90vh',  backgroundColor: 'transparent'}}>

                    <div className={`${isFullscreen ? '' : 'grid grid-cols-12 gap-x-6 ml-2'}`}>
                        ...
                        <div className={`${isFullscreen ? "col-span-12" : "xxl:col-span-8"}`}>
                            <div
                      ...
                      `}
                                            >
                                                <div
                                                    className={`flex items-center justify-center w-5 h-5 rounded-md mr-2 transition-all duration-300
                          ${
                                                        activeTab === "objectives"
                          ...
                          ${
                            ...
                            ${
                                            ...
                                            {activeTab === "objectives" && (
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        // Scroll to the new KRA after a brief delay
                                                        setTimeout(() => {
                                                            const kraContainer = document.querySelector('.space-y-6.overflow-y-auto');
                                                            if (kraContainer) {
                                                                kraContainer.scrollTop = kraContainer.scrollHeight;
                                                            }
                                                        }, 100);
                                                    }}
                                ...
                                <div className="relative" >
                                    {activeTab === "objectives" && (
                                        ...
                                        >
                                            <div className="space-y-6 overflow-y-auto max-h-[600px] pr-2" style={{
                                                background: "linear-gradient(to right, white calc(100% - 6px), #e5e7eb 6px)"
                                            }}>
                            ...
                            <div
                                className={`fixed bottom-0 ${
                                    isFullscreen ? "left-0" : "left-60"
                                } right-0 z-50 bg-white/95 backdrop-blur-lg border-t border-slate-200/80 shadow-2xl`}
                            >
                                            ...
                                            <div className="flex items-center space-x-4">
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        <Save
                                                            className={`w-3 h-3 ${
                                                                isSubmitting ? "animate-spin inline-block" : ""
                                                            }`}
                                                        />
                                                    </div>
                                                    Save Draft
