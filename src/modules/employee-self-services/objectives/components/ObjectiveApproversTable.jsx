                ...
                <div className="table-responsive task-table overflow-hidden transition-all duration-300 min-h-[100px]">
                    <table className="table whitespace-nowrap table-bordered min-w-full">
                        ...
                        <tr className="border-b border-defaultborder bg-slate-100">
                            <th className="px-4 py-2 text-left text-sm font-semibold text-slate-700  dark:text-gray-200 dark:bg-bodybg">Level</th>
                            <th className="px-4 py-2 text-left text-sm font-semibold text-slate-700 dark:text-gray-200 dark:bg-bodybg">Approver</th>
                            <th className="px-4 py-2 text-left text-sm font-semibold text-slate-700 dark:text-gray-200 dark:bg-bodybg">Designation</th>
                        </tr>
                        </thead>
                        <tbody>
                        {sortedApprovers.map((item) => (
                            <tr key={item.approver.id} className="border-b">
                                <td style={{ fontWeight: "bold" }} className="px-4 py-3 text-sm text-slate-600 dark:text-gray-200">
                        ...
                        <span className="font-semibold text-slate-900 text-left dark:text-gray-200">
                          ...
                          {item.approver.email}
                                ...
                                <td className="px-4 py-3 text-sm font-medium text-indigo-600 dark:text-gray-200">
