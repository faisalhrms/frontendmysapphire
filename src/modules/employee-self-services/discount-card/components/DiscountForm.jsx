...
const DiscountForm = ({
  ...
  // Function to handle search and display result
  const onSearchClick = () => {
    if (selectedOption === "email" && filteredData?.email) {
      setSearchResult(`Email: ${filteredData?.email}`);
            ...
            <div className="box-body">
              <div className="flex flex-wrap justify-between items-center">
                ...
                <FormButton
                    ...
                    onClick={onSearchClick} // Set the filter result when search button is clicked
                />
              </div>
            </div>
          </div>
            ...
            {isLoading ? (
                ...
                <>
                  <div className="flex flex-col items-center mb-4">
                    ...
                    {searchResult && (
                        <h6 className="text-sm opacity-80">{searchResult}</h6>
                    )}
