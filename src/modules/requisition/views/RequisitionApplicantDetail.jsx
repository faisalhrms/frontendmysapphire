// src/modules/requisition/views/RequisitionApplicantDetail.jsx
...
const RequisitionApplicantDetail = () => {
    const { requisitionId, applicationId } = useParams(); // ✅ match routes
