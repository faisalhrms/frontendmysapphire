...
const AgreementPlacementForm = forwardRef(
  (
    ...
    const {
      fields: splitDeliveries,
      append: appendSplitDelivery,
      remove: removeSplitDelivery,
      replace: replaceSplitDeliveries,
    } = useFieldArray({
      control,
      name: "split_deliveries",
    })
    ...
    useEffect(() => {
      ...
      const first = splitDeliveries[0]
      if (first && first.fabric_delivery) {
        setValue("fabric_delivery", first.fabric_delivery)
      }
    }, [splitQuantityEnabled, splitDeliveries, setValue])
    ...
    useEffect(() => {
      ...
      setValue(
        "greige_item_code",
        v.greige_item_code || m.greige_item_code || "",
      )
            ...
            <div className="col-span-12 lg:col-span-5 min-w-0">
              <div className="grid grid-cols-12 gap-4">
                    ...
                    >
                      ...
                      <div className="space-y-0.5">
                        ...
                        <div className="opacity-80">
                          ...
                          {deliveryDeviation.diff !== 1 ? "s" : ""} between need
                          by date and received fabric delivery.
                          {deliveryDeviation.level === "soft" &&
                ...
                <div className="col-span-12">
                  <div className="rounded-xl ring-2 ring-violet-300/60 dark:ring-violet-700 p-4">
                    <div className="grid grid-cols-12 gap-4">
                      ...
                      <div className="col-span-12 md:col-span-6">
                        <FormInput
                          name="warp_yarn_source"
                          control={control}
                          errors={errors}
                          placeholder="Warp Yarn Source"
                          disabled={isYarnFieldsReadOnly}
                        />
                      </div>
                      <div className="col-span-12 md:col-span-6">
                        <FormInput
                          name="weft_yarn_source"
                          control={control}
                          errors={errors}
                          placeholder="Weft Yarn Source"
                          disabled={isYarnFieldsReadOnly}
                        />
                      </div>
                    </div>
                ...
                <AgreementActions
                  ...
                  hideSave={hideSave}
                  mode={
                    showApprovalActions && canTakeAction ? "approval" : "edit"
                  }
                  onApprove={
                    showApprovalActions && canTakeAction
                      ? handleApproveInternal
                      : undefined
                  }
                  onReject={
                    showApprovalActions && canTakeAction
                      ? handleRejectInternal
                      : undefined
                  }
                  disabledApprove={saving || approvalSubmitting}
                  disabledReject={approvalSubmitting}
                />
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-7 w-full min-w-0 rounded-xl border-2 border-slate-200/80 dark:border-white/10 overflow-hidden">
              ...
              <div className="p-4 space-y-5">
                <AgreementFabric
                  ...
                  construction={
                    watch("construction") ||
                    matchedItem?.fab_construction ||
                    ""
                  }
                  weave={matchedItem?.weave || ""}
                  selvedge={matchedItem?.selvedge || ""}
                  warpBlend={
                    watch("warp_blend") || matchedItem?.warp_blend || ""
                  }
                  weftBlend={
                    watch("weft_blend") || matchedItem?.weft_blend || ""
                  }
