      ...
      <div className="box mb-4">
        <div className="box-body">
          <div className="flex gap-4">
            <TabBtn active={tab==="email"} onClick={()=>setTab("email")} Icon={Mail} label="Email" />
            <TabBtn active={tab==="api"} onClick={()=>setTab("api")} Icon={Globe} label="API" />
            <TabBtn active={tab==="excel"} onClick={()=>setTab("excel")} Icon={FileSpreadsheet} label="Excel" />
          </div>
        </div>
      </div>
