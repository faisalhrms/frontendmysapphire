...
const ReprocessEmailsModal = ({ closeModal, config, reprocessFn, onDone }) => {
  const [days, setDays] = useState(30)
  const [since, setSince] = useState("")
  const [isSubmitting, setIsSubmitting] = useState(false)
  const modalId = "reprocessEmailsModal"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = await reprocessFn({
        ...
        <div className="max-h-full mx-auto overflow-hidden ti-modal-content">
          <form onSubmit={handleSubmit}>
            <div className="ti-modal-header">
              <h6 className="modal-title">Reprocess Emails</h6>
              <button
                type="button"
...
export default ReprocessEmailsModal
