...
import {
  createWeavingParameter,
  getWeavingParameterById,
  updateWeavingParameter
...
export const useWeavingParameterForm = (editMode = false, paramId = null) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      wider_loom_speed: "",
      wider_efficiency: "",
      wider_reject_percent: "",
      narrow_loom_speed: "",
      narrow_efficiency: "",
      narrow_reject_percent: "",
      recovery: "",
      wider_dyeing_cost_percent: "",
      wider_packing_cost_per_yard: "",
      narrow_dyeing_cost_percent: "",
      narrow_packing_cost_per_yard: ""
    }
  })
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      reset({
        ...
        recovery: d.recovery ?? "",
        wider_dyeing_cost_percent: d.wider_dyeing_cost_percent ?? "",
        wider_packing_cost_per_yard: d.wider_packing_cost_per_yard ?? "",
        narrow_dyeing_cost_percent: d.narrow_dyeing_cost_percent ?? "",
        narrow_packing_cost_per_yard: d.narrow_packing_cost_per_yard ?? ""
      })
    })()
