                ...
                <div className="col-span-12">
                    ...
                    <div className="box shadow-md rounded-lg">
                        <div className="box-header bg-gray-100 p-4 rounded-t-lg">
                            <div className="box-title text-lg font-semibold">Personal & Application Info</div>
                        </div>
                    ...
                    <SubFormSection title="Qualifications" className="mt-6">
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                {qualFields.map((item, idx) => (
                                    <tr key={item.id} className="hover:bg-gray-100">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <FormInput label={false} name={`qualification_set.${idx}.institution`}
                                                       control={control} errors={errors} placeholder="Institution"
                                                       className="w-full"/>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="flex justify-end mt-4">
                            <button type="button" onClick={() => appendQual({ level: "", institution: "", years_completed: 0 })} className="ti-btn ti-btn-secondary ti-btn-md" title="Add a new qualification">
                                Add Qualification
                            </button>
                        </div>
                    </SubFormSection>
                    ...
                    <SubFormSection title="Work Experiences" className="mt-6">
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                {expFields.map((item, idx) => (
                                    <tr key={item.id} className="hover:bg-gray-100">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <FormInput label={false} name={`experience_set.${idx}.company_name`}
                                                       control={control} errors={errors} placeholder="Company"
                                                       className="w-full"/>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <FormInput label={false} name={`experience_set.${idx}.designation`}
                        ...
                        <div className="flex justify-end mt-4">
                            <button type="button" onClick={() => appendExp({ company_name: "", designation: "", years_in_role: 0, total_experience_years: 0 })} className="ti-btn ti-btn-secondary ti-btn-md" title="Add a new experience">
                                Add Experience
                            </button>
                        </div>
                    </SubFormSection>
