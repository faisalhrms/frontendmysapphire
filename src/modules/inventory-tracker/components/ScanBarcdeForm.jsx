                        ...
                        <div className="px-4 py-6 bg-white">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <div>
                                        <span className="text-lg text-gray-700 font-medium">Barcode: </span>
                                        <span className="text-lg text-gray-700">{currentWarehouse.barcode}</span>
                                    </div>
                                    <div>
                                        <span className="text-lg text-gray-700 font-medium">Size: </span>
                                        <span className="text-lg text-gray-700">{currentWarehouse.sizes}</span>
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    <div>
                                        <span className="text-lg text-gray-700 font-medium">Price: </span>
                                        <span className="text-lg text-gray-700">{currentWarehouse.salesprice}</span>
                                    </div>
                                    <div>
                                        <span className="text-lg text-gray-700 font-medium">Disc: </span>
