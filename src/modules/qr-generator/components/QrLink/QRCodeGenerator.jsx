...
// // import {Globe, Pyramid, Download, MessageCircle} from 'lucide-react';
...
// //
// //     const { qrCodes, addQRCode } = useQRManager(); // Removed deleteQRCode if unused
...
// //         if (!url.trim()) return;
// //         // Navigate to customize route and pass form data as state
// //         navigate('/module/qr/qr-customize', {
// //             state: { url: url.trim(), qrName, category }
// //         });
// //     };
// //
// //     return (
...
const QRCodeGenerator = () => {
    ...
    const contentTypes = [
        ...
        { id: 'whatsapp', label: 'WhatsApp', icon: MessageCircle ,color: "text-success",},
        { id: 'facebook', label: 'FaceBook', icon: Facebook ,color: "text-blue", },
        { id: 'youtube', label: 'YouTube', icon: Youtube, color: "text-red", },
    ];
