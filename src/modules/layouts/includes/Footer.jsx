const Footer = () => {
  ...
  <>
    ...
    <div className="container">
        <span className="text-gray dark:text-defaulttextcolor/50"> Copyright © <span id="year">2025</span>
            <a href="#" className="text-defaulttextcolor font-semibold dark:text-defaulttextcolor"> Sapphire</a>
        </span>
    </div>
</footer>
  </>
