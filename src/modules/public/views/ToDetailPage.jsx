...
export default function ToDetailPage() {
    ...
    return (
        <div className={`min-h-screen py-4 px-3 sm:px-4 lg:px-6 ${
            isDark ? 'dark:text-gray-200 dark:bg-bodybg' : 'bg-gray-50'
        }`}>
            <div className="max-w-7xl mx-auto">
                ...
                <div className={`p-5 mb-4 ${
                    isDark ? 'dark:text-gray-200 dark:bg-bodybg' : ''
                }`}>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    ...
                                    <tr className="bg-gradient-to-r from-slate-700 to-slate-600 text-white">
                                        ...
                                        <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider  min-w-80">
                                            Transfer Order No
                                        </th>
                                        <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider min-w-96">
                                    ...
                                    <tbody className={`divide-y ${
                                        isDark ? 'dark:text-gray-200 dark:bg-bodybg border border-gray-200 bg-gray-50' : 'divide-gray-200 bg-white'
                                    }`}>
                                    {(data?.items ?? []).length === 0 ? (
                                        <tr>
                                                ...
                                                <div className="flex flex-col items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className={`text-sm mt-1 ${
                                                            isDark ? 'text-gray-400' : 'text-gray-500'
                                                        }`}>There are no items in this transfer order</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        data.items.map((row, idx) => (
                                            <tr key={idx} className={`hover:${
                                                ...
                                                <td className="px-5 py-4  min-w-80">
                                                    <span className={`text-sm font-medium ${
                                                        isDark ? 'text-gray-100' : 'text-gray-900'
                                                    }`}>{row.transfer_order_no ?? '-'}</span>
                                                </td>
                                                <td className="px-5 py-4 min-w-96">
                                                    <div className="flex items-center gap-2">
                                                        <span className={`text-sm font-medium font-mono ${
                                                            isDark ? 'text-gray-100' : 'text-gray-900'
                                                        }`}>{row.carton_number ?? '-'}</span>
                                                        {/*<button className={`p-1 hover:${*/}
                                                        {/*    isDark ? 'bg-gray-600' : 'bg-gray-200'*/}
                                                        {/*} rounded transition-colors`} title="Copy carton number">*/}
