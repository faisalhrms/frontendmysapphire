...
const PendingReqTaskForm = ({ pendingReqData }) => {
  ...
  const processedDescription = useMemo(
    () => processEmailContent(pendingReqData?.description, pendingReqData?.attachments),
    [pendingReqData]
  );
  ...
  useEffect(() => {
    if (processedDescription) {
      setValue("description", processedDescription);
    }
  }, [processedDescription, setValue]);
              ...
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="xl:col-span-4 col-span-12">
                  <FormAsyncSelect
                    ...
                    onChange={(selected) => {
                      setValue("location_id", selected?.value || null);
                    }}
                  />
                </div>
                <div className="xl:col-span-4 col-span-12">
