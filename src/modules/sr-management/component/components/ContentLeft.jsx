...
function ContentLeft({generatedReqData, serviceRequest}) {
                    ...
                    <table className="w-full text-sm text-gray-600">
                        ...
                        <tr className="border-b border-gray-200">
                            ...
                            <td className="py-3 text-gray-700 text-normal dark:text-gray-400">
                                {serviceRequest.created_at ? new Date(serviceRequest.created_at).toLocaleString() : "No Date"}
                            </td>
                        </tr>
                        ...
                        <tr className="border-b border-gray-200">
                            ...
                            <td className="py-3 text-gray-700 text-normal dark:text-gray-200">
                                {serviceRequest.need_by_date ? new Date(serviceRequest.need_by_date).toLocaleDateString() : "No Need By Date"}
                            </td>
                            <td className="py-3 font-semibold text-gray-800 dark:text-gray-200">
                                Created By:
                            </td>
                        ...
                        <tr>
                            ...
                            <td className="py-3 text-gray-700 ext-normal dark:text-gray-200">{serviceRequest.cc_email_names || '-'} </td>
                            <td className="py-3 font-semibold text-gray-800 dark:text-gray-200">
                                On Behalf Of:
                            </td>
