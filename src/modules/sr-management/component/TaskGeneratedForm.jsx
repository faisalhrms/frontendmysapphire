...
import LinkTaskModal from "@modules/sr-management/component/LinkTaskModal.jsx";
    ...
    const handleLinkTask = async (srNumber) => {
        ...
        try {
            ...
            if (response.data.linked) {
                Notify.success("Service request linked successfully");
                await refreshServiceData();
            } else {
                Notify.error("Failed to link service request");
            }
        } catch {
            Notify.error("Failed to link service request");
        } finally {
                ...
                <div className="box-body">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex gap-3">
                            ...
                            >
                                <i className="ri-add-line align-middle"></i> Sub Task
                            </button>
                            <button
                                onClick={handleOpenLinkModal}
                                className="ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]"
                            >
                                <i className="ri-links-line align-middle"></i> Link Task
                            </button>
                        </div>
