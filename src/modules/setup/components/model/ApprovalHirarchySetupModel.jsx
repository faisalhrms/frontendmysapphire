...
const ApprovalHirarchySetupModal = ({
                                        control,
                                        errors,
                                        closeModal,
                                        handleSubmit,
                ...
                <div className="ti-modal-content">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="ti-modal-header">
                            <h6 className="modal-title">Approval Hirarchy Setup</h6>
                            <button
                                type="button"
                                className="hs-dropdown-toggle ti-modal-close-btn"
                                onClick={closeModal}
                                data-hs-overlay="#approvalSetupModal"
                            >
                        ...
                        <div className="ti-modal-body">
                            <div className="col-span-12">
                                <label
                                    htmlFor="type"
                                    className="block text-sm  text-gray-900  dark:text-gray-200 dark:bg-bodybg"
                                >
                                    Type
                                </label>
                                <input
                                    id="type"
                                    type="text"
                                    value={formOption?.label || "type"}
                                    readOnly
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm bg-gray-100 cursor-not-allowed  dark:text-gray-200 dark:bg-bodybg"
                                />
                            </div>
                            <ApproversFieldArray
                                control={control}
...
export default React.memo(ApprovalHirarchySetupModal);
