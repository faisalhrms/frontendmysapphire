...
const RecentProjectCard = ({ filters }) => {
    const { data: projects, isLoading } = useFetchWithFilters(
        '/dashboard/pms/statistics/recent-projects/', filters
    );
    return (
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            className="text-[#8c9097] dark:text-white/50 opacity-[0.6] inline-block">{formatDate(project.ended_at)}</span>
