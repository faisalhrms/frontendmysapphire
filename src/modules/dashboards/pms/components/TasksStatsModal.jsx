...
// //                                         ...item,
// //                                         progress: <ProgressBar value={item.progress}  withStatus={false}  />
// //                                     })) || []}
// //                                 />
// //                             </div>
// //                         ) : (
...
//
//
//                                 <hr className="border-t border-gray-400 my-4 mt-4 mb-4" />
//
//                                 <Table
//                                     tableConfig={tableConfig}
//                                     data={data?.details?.map(item => ({
                            ...
                            <div className="flex-grow">
                                ...
                                <Table
                                    ...
                                    data={data?.details?.map(item => ({
                                        ...item,
                                        progress: <ProgressBar value={item.progress} withStatus={false} />,
                                        status: <span className="bg-warning/10 text-warning px-2 py-1 rounded-md font-semibold">{item.status || "N/A"}</span>
                                    })) || []}
                                />
                            </div>
                        ) : (
