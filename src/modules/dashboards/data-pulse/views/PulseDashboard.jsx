...
import {formatAmountWithCommas, formatRoundedAmountWithCommas} from "@helpers/formatters.js";
...
const PulseDashboard = () => {
    ...
    // ✅ enabled flags (hooks always called)
    ...
    const chartTopCoupons = useMemo(
        () =>
            topCoupons.map((r) => ({
                name: r.coupon_code || r.OrderNumber || "-",
                value: Number(r.coupon_amount) || 0,
            })),
        [topCoupons]
    );

    const chartTopStoreCredit = useMemo(
        () =>
            topStoreCredit.map((r) => ({
                name: r.OrderNumber || "-",
                value: Number(r.store_credit_amount) || 0,
            })),
        [topStoreCredit]
    );


    // Derived KPI helpers (safe)
                ...
                <>
                    {activeTab === "overview" && (
                        <>
                            {/* KPI cards */}
                            <div
                                className="rounded-lg shadow-sm border border-gray-200 dark:text-gray-200 dark:bg-bodybg">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    <StatCard
                                        icon={Receipt}
                                        title="Orders"
                                        value={kpiLoading ? '...' : formatRoundedAmountWithCommas(ordersCount)}
                                        subtitle="Last 7 days (excl today)"
                                    />
                                    <StatCard
                                        icon={TrendingUp}
                                        title="Gross Sales"
                                    ...
                                    <StatCard
                                        ...
                                        subtitle={kpiLoading ? '...' : `${formatRoundedAmountWithCommas(storeCreditCount)} txns`}
                                    />
                                    <StatCard
                                        icon={BadgePercent}
                                        title="Coupons"
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div
                                                ...
                                                <p className="text-xs text-white/70">Last 7 days (excl today)</p>
                                            </div>

                                            <div className="bg-white/10 p-2 rounded-lg text-white/90 text-sm">
                                                <span className="font-semibold">Tip:</span> Review top orders below for
                                                VIP buyers.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div
                                                ...
                                                <p className="text-xs text-white/70">
                                                    Txns: {formatRoundedAmountWithCommas(storeCreditCount)}
                                                </p>
                                            </div>
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="text-xs text-white/70">Δ &gt; 1 (ceil rule)</p>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <RotateCcw size={16}/>
                                                Review COD mismatches + incomplete accounts first.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <SimpleTable
                                                    columns={[
                                                        ...
                                                        {key: "OrderedDate", label: "Ordered Date"},
                                                        {
                                                            ...
                                                            strong: true,
                                                            render: (r) =>
                                                                `PKR ${formatRoundedAmountWithCommas(r.store_credit_amount)}`,
                                                        },
                                                        {
                                                            key: "total_payment_amount",
                                                            label: "Total Paid",
                                                            align: "right",
                                                            render: (r) =>
                                                                `PKR ${formatRoundedAmountWithCommas(r.total_payment_amount)}`,
                                                        },
                                                    ]}
                                                    rows={topStoreCredit}
                                                />
                                            ...
                                            <SimpleTable
                                                columns={[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        align: "right",
                                                        render: (r) =>
                                                            `PKR ${formatRoundedAmountWithCommas(r.calculated_amount)}`,
                                                    },
