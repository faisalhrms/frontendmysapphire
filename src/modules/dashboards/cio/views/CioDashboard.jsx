...
import { Sleeptracking, Watertracking } from '../ciodummydata/ciodata.jsx';
...
const CioDashboard = () => {
    return (
        <>
            <PageHeader currentpage="Cheif Infomation Officer" activepage="Dashboards" mainpage="Cheif Infomation Officer" />
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div>
                                                    <p className="mb-0">
                                                        ...
                                                        <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] mx-1 inline-flex">Lt</span>
                                                    </p>
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div>
                                                    <p className="mb-0">
                                                        ...
                                                        <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] mx-1 inline-flex">Hrs</span>
                                                    </p>
                                ...
                                <div className="box-body !p-0">
                                    <div className="flex flex-wrap items-center border-b border-dashed dark:border-defaultborder/10">
                                        <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] me-1 inline-flex">6 min ago</span>
                                                <span className="text-danger"><i className="bi bi-arrow-down-right me-1 text-[0.625rem]"></i>1.5%</span>
                                            </div>
                                        </div>
                                        <div className="px-6 py-4 flex-grow border-b border-dashed dark:border-defaultborder/10">
                                            <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] me-1 inline-flex">1 hr ago</span>
                                                <span className="text-warning"><i className="bi bi-arrow-down-right me-1 text-[0.625rem]"></i>1.9%</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex flex-wrap items-center">
                                        <div className="px-6 py-4 flex-grow border-e border-dashed dark:border-defaultborder/10">
                                            ...
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] me-1 inline-flex">1 day ago</span>
                                                <span className="text-info"><i className="bi bi-arrow-up-right me-1 text-[0.625rem]"></i>1.9%</span>
                                            </div>
                                        </div>
                                        <div className="px-6 py-4 flex-grow border-dashed dark:border-defaultborder/10">
                                            ...
                                            <p className="mb-2 text-[1.5rem] font-semibold">2.1K</p>
                                            <div className="flex-between">
                                                <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] me-1 inline-flex">1 week ago</span>
                                                <span className="text-purple"><i className="bi bi-arrow-up-right me-1 text-[0.625rem]"></i>1.9%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="box">
                                <div className="box-body">
                                    ...
                                    <div className=" text-center">
                                        <Link to={`${import.meta.env.BASE_URL}pages/profile`} className="ti-btn ti-btn-primary !me-[0.375rem] !font-medium !py-1 !px-2 !text-[0.75rem]">
                                            Edit Profile
                                        </Link>
                                    ...
                                    <ul className="list-none personal-favourite-contacts mb-0">
                                            ...
                                            <div className="flex items-center">
                                                <div className="me-2">
                                                    <span className="avatar">
                                                        <img src={face2} alt="" className="rounded-md" />
                                                    </span>
                                                </div>
                                                <div className="flex-grow">
                                        ...
                                        <li>
                                            <div className="flex items-center">
                                                <div className="me-2">
                                                    <span className="avatar">
                                                        <img src={face9} alt="" className="rounded-md" />
                                                    </span>
                                                </div>
                                                <div className="flex-grow">
                                        ...
                                        <li>
                                            <div className="flex items-center">
                                                <div className="me-2">
                                                    <span className="avatar">
                                                        <img src={face10} alt="" className="rounded-md" />
                                                    </span>
                                                </div>
                                                <div className="flex-grow">
