...
const SrDashboard = () => {
    ...
    const {serviceRequest, applyFilters, downloadExcel, isDownloading} = useServiceRequest(storedFilters);
            ...
            <div className="grid grid-cols-12 gap-x-6 mb-1">
                <div className="xl:col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12">
                    <div className="btn-list md:mt-0 mt-0 float-end flex space-x-2">
                        <button type="button"
                                className="ti-btn bg-primary text-white !font-medium !text-sm !rounded py-2 px-4 shadow-lg"
                        ...
                        <button
                            ...
                            className="ti-btn ti-btn-outline-secondary !font-medium !text-sm !rounded py-2 px-4 shadow-lg"
                        >
                            <i
                    ...
                    <div
                        className={`transition-all duration-300 ease-in-out overflow-hidden ${showFilters ? "max-h-[1000px] opacity-100 mt-4" : "max-h-0 opacity-0"}`}>
                        <div className="box bg-white shadow-lg rounded-lg p-4">
                            <div className="box-body">
                                <div className="grid grid-cols-12 gap-4">
                                    ...
                                    <div className="xl:col-span-3 col-span-12">
                                        <DepartmentDropdown company_id={company} control={control} errors={errors}
                                                            onDepartmentSelect={handleDepartmentSelect}/>
                                    </div>
                                    <div className="xl:col-span-3 col-span-12">
                                        <SubDepartmentDropdown department_id={department} control={control}
                                                               errors={errors}
                                ...
                                <div className="flex justify-center mt-6 space-x-4">
                                    <button type="button"
                                            className="ti-btn bg-primary text-white font-medium rounded py-2 px-6 shadow-lg"
                                            onClick={onSearchClick}>
                                        <i className="ri-search-2-line inline-block"></i> Apply Filter
                                    </button>
                                    <button type="button"
                                            className="ti-btn ti-btn-outline-secondary font-medium rounded py-2 px-6 shadow-lg"
                        ...
                        <div
                            ...
                            <div>
                                <Rating name={`clickable-rating-${index}`} value={item.rating}
                                        onChange={handleRatingChange2} readOnly/>
                            </div>
                        </div>
                    </div>
                ))}
