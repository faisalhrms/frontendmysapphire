...
import { AudienceReport, Bouncerate, Clicks, Impressions, Sessionbydevice, Sessionduration, TopCountries, Totalusers, Visitorsbychannel, Visitorsbycountries } from '../csData/csdummyData.jsx';
import media84 from "@assets/images/media/media-84.png";

const CsDashboard = () => {
    return (
        <>
            <PageHeader currentpage="Cyber Security" activepage="Dashboards" mainpage="Cyber Security" />
                        ...
                        <div className="xxl:col-span-6 xl:col-span-12 col-span-12">
                            <div className="box">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="hs-dropdown ti-dropdown  rtl:[--placement:top-right]">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-hover whitespace-nowrap min-w-full">
                                            ...
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-[78%]" style={{width: "78%"}} aria-valuenow={78} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-[32%]" style={{width: "32%"}} aria-valuenow={32} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-[21%]" style={{width: "21%"}} aria-valuenow={21} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-1/4" style={{width: "25%"}} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-[35%]" style={{width: "35%"}} aria-valuenow={35} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="border-t border-inherit border-solid hover:bg-gray-100 dark:hover:bg-light dark:border-defaultborder/10">
                                                ...
                                                <td className="border-bottom-0">
                                                    <div className="progress progress-xs">
                                                        <div className="progress-bar bg-primary w-[12%]" style={{width: "12%"}} aria-valuenow={12} aria-valuemin={0} aria-valuemax={100}>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                {Visitorsbycountries.map((idx) => (
                                    <li key={Math.random()}>
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                <span className="text-default badge bg-light font-semibold mt-2">{idx.badge}</span>
                                            </div>
                                        </div>
                                    </li>
                                ))}
