...
import { Countries, Earning, ProductsOverview, Recentorders } from '../biDummyData/biData.jsx';
...
const BiDashboard = () => {
    ...
    return (
        <>
            <PageHeader currentpage="Business Intelligence" activepage="Dashboards" mainpage="Business Intelligence" />
                            ...
                            <div className="box">
                                <div className="box-header justify-between">
                                    ...
                                    <div className="hs-dropdown ti-dropdown">
                                        <Link aria-label="anchor" to="#" className="flex items-center justify-center w-[1.75rem] h-[1.75rem] !text-defaulttextcolor !text-[0.8rem] !py-1 !px-2 rounded-sm bg-light border-light shadow-none !font-medium"
                                        ...
                                        <div className="tab-pane text-[#8c9097] dark:text-white/50 !border-0 !p-0 hidden" id="completed" role="tabpanel" aria-labelledby="completed-item">
                                            <div className="table-responsive overflow-auto">
                                                <table className="table card-table table-vcenter whitespace-nowrap mb-0 min-w-full">
                                                    ...
                                                    <tr className="border-y border-inherit border-solid">
                                                        <td>
                                                            <div className="flex items-center">
                                                                <div className="leading-none">
                                                                        <span className="avatar avatar-md offline avatar-rounded me-2 !mb-0">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table whitespace-nowrap min-w-full mb-0">
                                            ...
                                            <tr className="border-y border-inherit border-solid dark:border-defaultborder/10 ">
                                                <td className="text-center leading-none">
                                                        <span className="avatar avatar-md !rounded-full">
                                                            <img src={ecommerce38} className="p-2 !rounded-full bg-light" alt="" />
                                                        </span>
                                                </td>
                                            ...
                                            <tr className="border-y border-inherit border-solid dark:border-defaultborder/10 ">
                                                <td className="text-center leading-none">
                                                        <span className="avatar avatar-md !rounded-full">
                                                            <img src={ecommerce39} className="p-2 !rounded-full bg-light" alt="" />
                                                        </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td className="text-center leading-none">
                                                        <span className="avatar avatar-md !rounded-full">
                                                            <img src={ecommerce40} className="p-2 !rounded-full bg-light" alt="" />
                                                        </span>
                                                </td>
                                    ...
                                    <ul className="list-none mb-0">
                                            ...
                                            <Link to="#">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start justify-center">
                                                        <img src={face4} alt="" className="avatar avatar-md avatar-rounded !mb-0 me-2" />
                                                        <div>
                                        ...
                                        <li className="mb-4">
                                            <Link to="#">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start justify-center">
                                                        <img src={face15} alt="" className="avatar avatar-md avatar-rounded !mb-0 me-2" />
                                                        <div>
                                        ...
                                        <li className="mb-4">
                                            <Link to="#">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start justify-center">
                                                        <img src={face5} alt="" className="avatar avatar-md avatar-rounded !mb-0 me-2" />
                                                        <div>
                                        ...
                                        <li className="mb-0">
                                            <Link to="#">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start justify-center">
                                                        <img src={face2} alt="" className="me-2 avatar avatar-md avatar-rounded !mb-0" />
                                                        <div>
