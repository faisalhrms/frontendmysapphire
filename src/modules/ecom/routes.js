...
import OrderStatusReport from "@modules/ecom/views/OrderStatusReport.jsx";
...
export const ECOM_ROUTES = {
    ...
    SO:{
        path: '/module/ecom/order_status-report',
        permission: 'auth.order_status-report',
    },
};
...
export const MODULE_ROUTES = [
    ...
    {
        path: ECOM_ROUTES.SO.path,
        component: OrderStatusReport,
        permission: ECOM_ROUTES.SO.permission,
    },
