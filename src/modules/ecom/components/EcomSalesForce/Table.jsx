...
const EcomReconcilition = ({ title, data = [], totals = [], isLoading }) => {
    return (
        <div className="w-3/5 bg-white p-4 shadow-md rounded-lg mb-6 dark:text-gray-200 dark:bg-bodybg">
            <h2 className="text-sm font-bold text-gray-900 px-4 py-2 bg-gray-200 dark:text-gray-200 dark:bg-bodybg">
                {title}
            </h2>
...
// ✅ Fix: Use correct component name for PropTypes
EcomReconcilition.propTypes = {
...
export default EcomReconcilition;
