                    ...
                    {data.length > 0 ? (
                        data.map((row, rowIndex) => (
                            <tr key={rowIndex} className="border border-gray-300 dark:border-gray-700 transition hover:bg-gray-100">
                                <td className="border border-gray-400 font-semibold dark:border-gray-700 text-center">{row.period}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.cy?.orders)}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.cy?.qty)}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.cy?.value)}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.ly?.orders)}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.ly?.qty)}</td>
                                <td className="border border-gray-400 dark:border-gray-700 text-center">{formatNumber(row.ly?.value)}</td>
                                <td className={`border border-gray-400 dark:border-gray-700 text-center ${row.yoy?.orders < 0 ? 'text-red-600' : ''}`}>
                                    {formatPercentage(row.yoy?.orders).value}
                                </td>
                                <td className={`border border-gray-400 dark:border-gray-700 text-center ${row.yoy?.qty < 0 ? 'text-red-600' : ''}`}>
                                    {formatPercentage(row.yoy?.qty).value}
                                </td>
                                <td className={`border border-gray-400 dark:border-gray-700 text-center ${row.yoy?.value < 0 ? 'text-red-600' : ''}`}>
