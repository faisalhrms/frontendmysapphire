...
//                         <th rowSpan="2" className="py-2 px-4 border border-gray-400">Name Origin</th>
//                         <th colSpan="3" className="py-2 px-4 border border-gray-400">Last Day</th>
//                         <th colSpan="3" className="py-2 px-4 border border-gray-400">MTD</th>
//                     </tr>
//                     <tr className="bg-gray-200 text-black text-sm">
//
//                         <th className="py-2 px-4 border border-gray-400">GoogleAds</th>
//                         <th className="py-2 px-4 border border-gray-400">MetaAds</th>
...
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.lastDay.googleAds.toLocaleString()}</td>
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.lastDay.metaAds.toLocaleString()}</td>
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.lastDay.total.toLocaleString()}</td>
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.mtd.googleAds.toLocaleString()}</td>
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.mtd.metaAds.toLocaleString()}</td>
//                                 <td className="px-4 py-2 border text-right">{region.totalRow.mtd.total.toLocaleString()}</td>
//                             </tr>
//
//
//                             {region.subCategories.map((sub, subIdx) => (
//                                 <tr key={subIdx} className="bg-gray-100 ">
//                                     <td className="px-4 py-2 border">{sub.objective}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.lastDay.googleAds.toLocaleString()}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.lastDay.metaAds.toLocaleString()}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.lastDay.total.toLocaleString()}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.mtd.googleAds.toLocaleString()}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.mtd.metaAds.toLocaleString()}</td>
//                                     <td className="y-2 px-4 border border-gray-200 dark:text-gray-200 dark:bg-bodybg text-right">{sub.mtd.total.toLocaleString()}</td>
//                                 </tr>
//                             ))}
//                         </React.Fragment>
//                     ))}
