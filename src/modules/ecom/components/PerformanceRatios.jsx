...
import PerformanceFulfillmentTable from "../components/PerformanceFulfillmentTable.jsx"
import {courierdata, Couriertotals, fulfillmentData,  totalsData} from "@modules/ecom/components/utils.js";
import PerformanceCourierTable from "@modules/ecom/components/PerformanceCourierTable.jsx";
    ...
    return (
        <>
            <div className="flex flex-wrap md:flex-nowrap gap-6 p-4">
                <PerformanceRationsTable title="Return by Courier" columns={returnPerformanceColumns}
                                         data={returnPerformanceData} totals={totals}/>
                <CancellationTable title=" Cancellation before Pick-up" headers={cancellationHeaders}
                                   data={cancellationData}/>
              </div>
            <div className="flex flex-wrap md:flex-nowrap gap-6 p-4">
                <PerformanceFulfillmentTable
                    tableTitle="Fulfillment Allocation "
                    fulfillmentData={fulfillmentData}
                    totalsData={totalsData}
                />
                <PerformanceCourierTable
