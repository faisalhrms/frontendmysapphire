    ...
    return (
        <div className="p-4 bg-white shadow-lg rounded-lg mb-6 dark:text-gray-200 dark:bg-bodybg">
            ...
            <div className="overflow-x-auto mb-4 dark:text-gray-200 dark:bg-bodybg">
                {loading ? (
                    <p className="text-center text-gray-600 dark:text-gray-200 dark:bg-bodybg">Loading data...</p>
                ) : (
                    <table className="w-full border border-gray-200 dark:text-gray-200 dark:bg-bodybg">
                        ...
                        <tr>
                            <th className="border p-2 text-center dark:text-gray-200 dark:bg-bodybg">Group</th>
                        ...
                        {data.length > 0 ? (
                            data.map((row, index) => (
                                <tr key={index} className="border hover:bg-gray-50 dark:text-gray-200 dark:bg-bodybg">
                                    ...
                                    <td className="border p-2 text-right dark:text-gray-200 dark:bg-bodybg">{row.merchandiseTotal}</td>
                                    ...
                                    <td className="border p-2 text-right dark:text-gray-200 dark:bg-bodybg">{row.itemsPerOrder}</td>
                                    <td className="border p-2 text-right dark:text-gray-200 dark:bg-bodybg">{row.conversion}</td>
                                </tr>
                            ))
                        ) : (
                            <tr>
                                <td colSpan="9" className="text-center p-4 dark:text-gray-200 dark:bg-bodybg">No data available</td>
                            </tr>
                        )}
                        </tbody>
                    </table>
