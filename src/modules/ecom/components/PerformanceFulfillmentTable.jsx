...
const PerformanceFulfillmentTable = ({ tableTitle, fulfillmentData, totalsData }) => {
    return (
        <div className="w-full bg-white p-4 shadow-md rounded-lg">
            <h2 className="text-lg font-bold text-black px-4 py-2 rounded-t">{tableTitle}</h2>
                ...
                <table className="min-w-full border-collapse border border-gray-400">
                    ...
                    {fulfillmentData.map((row, index) => (
                        <tr key={index} className="border-b">
                            <td className="py-2 px-4 border">{row.warehouse}</td>
                    ...
                    <tr className="font-bold text-black bg-gray-200">
                        ...
                        <td className="py-2 px-4 border">{totalsData.lastDay}</td>
                        <td className="py-2 px-4 border">{totalsData.last7Days}</td>
                        <td className="py-2 px-4 border">{totalsData.mtd}</td>
                        <td className="py-2 px-4 border">{totalsData.lastMonth}</td>
                        <td className="py-2 px-4 border">{totalsData.ytd}</td>
                    </tr>
                    </tfoot>
                </table>
            </div>
...
export default PerformanceFulfillmentTable;
