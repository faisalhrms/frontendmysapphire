...
import {useChainBulkUpload} from "@modules/road-map/Chain-Designer/hooks/useChainBulkUpload.js";

const BulkUploadModel = ({closeModal, refreshTable}) => {
    const {
        register,
        handleSubmit,
        errors,
    ...
    const handleClose = useCallback(() => {
        const modal = document.getElementById("bulkUploadModel");
        if (
            modal &&
            window.HSOverlay &&
