...
export default function ChatBot() {
  const {
    ...
    competitorChecks,
    setCompetitorChecks,
    tick,               // <<— used to trigger scroll updates while streaming
  } = useChatBot()
  ...
  // also react when tick changes (HTML streamed into same message)
  useEffect(() => {
    scrollToBottom()
                  ...
                  <div className="ml-8 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-4 py-3 max-w-4xl">
                    ...
                    {m.error ? (
                      ...
                      <div className={`${m.loading ? "min-h-[148px]" : ""}`}>
                        ...
                        {/* Render HTML while streaming and after final */}
                        {m.html && m.mode !== "qc" ? (
                          <div
