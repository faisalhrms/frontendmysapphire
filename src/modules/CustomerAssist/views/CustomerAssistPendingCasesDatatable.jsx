...
const CustomerAssistPendingCasesDatatable = ({ isActive }) => {
    if (!isActive) {
        return null
    }
    const columns = [
    ...
    return (
        <>
            <DataTable
                columns={columns}
                title="Customer Assist Pending Cases"
                apiUrl={`/customer-assist/cases/pending/datatable/`}
...
export default CustomerAssistPendingCasesDatatable;
