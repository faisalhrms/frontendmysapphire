        ...
        <>
            ...
            <form onSubmit={handleSubmit(handleEquipmentSubmit)}>
                <div className="grid grid-cols-12 gap-x-6 md:flex">
                                ...
                                <div className="grid grid-cols-12 gap-4">
                                    ...
                                    <div className="xl:col-span-4 col-span-12">
                                        <FormAsyncSelect
                                            ...
                                            saveOptionEndpoint="/select/equipment/site/"
                                    ...
                                    <div className="xl:col-span-4 col-span-12">
                                        <FormAsyncSelect
                                            ...
                                            queryKeyBase="types"
                                            clientSideSearch={true}
                                            preselectedOptions={formatOptions(equipmentData, "equipment_type","id","name")}
                    ...
                    {/* Purchase Date, HandOver Date, Maturity Date */}
