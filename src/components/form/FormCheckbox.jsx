...
const FormCheckbox = ({ name, label, control, errors, placeholder, classNames = "", is_required = false, childClassNames = 'me-4', ...rest }) => {
    return (
        <>
            {
                label && (
            ...
            <Controller
                ...
                render={({ field }) => (
                    <div className={`flex items-center ${classNames}`}>
                        <div className={`form-check !ps-0 ${childClassNames}`}>
                        <input
                            id={name}
                            type="checkbox"
                            {...field}
