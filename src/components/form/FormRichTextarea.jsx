    ...
    (
        {
            ...
            minHeight,                        // optional
            maxHeight,                        // optional
            contentPadding = "12px 14px 36px",// ✅ adds extra bottom padding
            containerClassName = "",          // ✅ add margin/padding outside editor
        ...
        const baseDefaultStyle =
            "font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 14px; line-height: 1.5; color: #334155;";

        const finalDefaultStyle = `${baseDefaultStyle} padding: ${contentPadding};`;
                    ...
                    render={({ field }) => (
                        <SunEditor
                            ...
                            setOptions={{
                                ...
                                // ✅ NEW: height controls
                                height: editorOptions.height ?? height,
                                minHeight: editorOptions.minHeight ?? minHeight,
                                maxHeight: editorOptions.maxHeight ?? maxHeight,

                                defaultStyle: editorOptions.defaultStyle ?? finalDefaultStyle,
                                stickyToolbar: false,
                                mode: "classic",
                                resizingBar: false,
                                showPathLabel: false,
                                ...
                                font: ["Inter", "Arial", "Helvetica", "sans-serif", "serif", "monospace"],
