...
//             className="hs-overlay ti-modal hidden fixed inset-0 flex items-center justify-center backdrop-blur-[0.08rem] [--overlay-backdrop:static]"
//         >
//             <div
//                 className="hs-overlay-open:mt-0 t ease-out w-[80%] sm:w-[350px] md:w-[400px] lg:w-[450px] mx-auto bg-white shadow-lg rounded-lg p-2">
...
//                                 {/*    <button*/}
//                                 {/*        className={`ti-btn ti-btn-${type}-full px-6 py-2 text-lg ${isSubmitting ? "ti-btn-disabled" : ""}`}*/}
//                                 {/*        type="button"*/}
...
//                                 {/*    </button>*/}
//                                 {/*    <button*/}
//                                 {/*        className="ti-btn ti-btn-success px-6 py-2 text-lg"*/}
//                                 {/*        type="button"*/}
//                                 {/*        onClick={closeModal}*/}
//                                 {/*    >*/}
//                                 {/*        No*/}
