...
const SubDepartmentDropdown = ({ control, errors, data, department_id = null, multiple = false,needObject= false, key = 'sub_department', classes = '', haveLabel = false, name = 'sub_department_id', onSubDepartmentSelect}) => {
